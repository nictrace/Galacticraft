...
//        if (this.placeBlock(chunk, meta, hx, this.posY, hz, cx, cz, VenusBlocks.tier2TreasureChest, 0))
//        {
...
//            {
//                this.worldObj.setBlock(coords.posX, coords.posY, coords.posZ, VenusBlocks.tier2TreasureChest, 0, 3);
//                this.worldObj.setTileEntity(coords.posX, coords.posY, coords.posZ, new TileEntityTreasureChestVenus());
