...
public class GLDebug
{
  ...
  public static GLDebug instance = new GLDebug();
  ...
  public static void preDebug() 
  {
    for (int i = 0; i < instance.propertyList.length; ++i) 
    {
      instance.propertyList[i].saveValue = getPropertyAsString(i);
    }
  }
  ...
  public static void postDebug() 
  {
    for (int i = 0; i < instance.propertyList.length; ++i) 
    {
      if (!instance.propertyList[i].saveValue.equals(getPropertyAsString(i)))
      {
    	  System.out.println(instance.propertyList[i].name + ": " + instance.propertyList[i].saveValue + " -> " + getPropertyAsString(i));   	  
      }
    }
  }
